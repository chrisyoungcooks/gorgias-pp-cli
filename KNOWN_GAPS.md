...
- **Roundtrip candidates.** `tags`, `macros`, `teams`,
...
- **Phone/voice integration.** Tenants without a voice integration have
  ...
  exercised against tenant data. The wire-shape is generated from the same spec as
